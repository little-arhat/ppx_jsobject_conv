...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5feb0f4cf3fc0f7e6f93969c954eec28) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Roma Sokolov"];
          authors = ["Roma Sokolov"];
          homepage = Some "https://github.com/little-arhat/ppx_jsobject_conv";
          synopsis = "Generate js_of_ocaml jsobject from type definition";
          description = Some [OASISText.Para "Useful"];
          categories = [];
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "ppx_jsobject_conv_runtime";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("js_of_ocaml.deriving", None);
                           FindlibPackage ("js_of_ocaml.deriving.ppx", None)
                        ];
                   ...
                   {
                      lib_modules = ["Ppx_jsobject_conv_runtime"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ppx_jsobject_conv_runtime";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ppx_jsobject_conv"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "1\151\023ï\012f?\146\016Å¡nS\bjo";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
